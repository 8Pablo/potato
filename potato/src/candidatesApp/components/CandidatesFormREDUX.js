...
class CandidatesFormRedux extends Component {
  static navigationOptions = ({navigation}) => {
    ...
    return {
      title      : <Text style={{alignSelf: 'center', color: "#206C97", fontWeight: 'normal'}}>CANDIDATES WITH
        REDUX</Text>,
      headerRight: (<Button title="Save/Add"
                            onPress={() => navigate('CandidatesListTrial')}/>),
...
export default connect(mapStateToProps, {candidateUpdate, candidateCreate})(CandidatesFormRedux);